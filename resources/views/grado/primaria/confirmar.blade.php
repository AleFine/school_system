...
@section('contenido')
<div class="container">
    <form id="gradoForm" action="{{ route('grado-cursos-primaria.show', ['grado_cursos_primarium' => '0']) }}" method="GET" class="d-flex justify-content-between align-items-center mb-3">
        @csrf
        <div class="row">
