...
<div class="container">
    ...
    <div class="mb-3">
        <a href="{{ route('cursos-secundaria.details', $nota->id_curso) }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Volver</a>
    </div>

    <form action="{{ route('cursos-secundaria.update-student', ['curso' => $nota->id_curso, 'estudiante' => $nota->id_estudiante]) }}" method="POST">
        @csrf
        @method('PUT')
